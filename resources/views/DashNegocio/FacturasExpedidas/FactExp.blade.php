						...
						<div class="m-portlet__head">
							<div class="m-portlet__head-caption">
								<div class="m-portlet__head-title">
									...
									<br>
									<a href="{{route ('Negocio/Facturas')}}" class="btn btn-accent btn-sm m-btn m-btn--custom m-btn--icon m-btn--pill m-btn--air">Regresar</a>
								</div>
							</div>
						</div>
					</div>
					...
					<table class="m-datatable" id="html_table" width="100%">
						...
						<tbody>
							@foreach($factura as $facturas)
    							<tr>
    								<td>{{$facturas->Nombre}} {{$facturas->Paterno}} {{$facturas->Materno}}</td>
