		...
		<div class="col-sm-12 col-md-8 col-lg-9">
			...
			<div class="m-portlet m-portlet--tab">
						...
						<div class="m-portlet__head">
							<div class="m-portlet__head-caption">
								<div class="m-portlet__head-title">
									...
									<br>
									<a href="{{route ('Negocio/MisNegocios')}}" class="btn btn-accent btn-sm m-btn m-btn--custom m-btn--icon m-btn--pill m-btn--air">Listado</a>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-xl-12">
						<!--begin::Form-->
						<form class="m-form m-form--fit m-form--label-align-right" role="form" method="POST" action="{{ route('Negocio/MisNegocios/Editar/', $negocio->id) }}">
