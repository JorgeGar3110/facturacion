						...
						<div class="m-portlet__head">
							<div class="m-portlet__head-caption">
								<div class="m-portlet__head-title">
									...
									<br>
									<a href="{{route ('Negocio/Registro')}}" class="btn btn-accent btn-sm m-btn m-btn--custom m-btn--icon m-btn--pill m-btn--air">Agregar negocio</a>
								</div>
							</div>
						</div>
					</div>
						...
						<tbody>
							@foreach($negocio as $negocios)
    							<tr>
                        			...
                        			<td>
                        				<a class="btn m-btn--pill    btn-outline-info btn-sm" href="{{route ('Negocio/MisNegocios/', $negocios->id)}}">
                        					Ver
                        				</a>
                        				<a class="btn m-btn--pill    btn-outline-brand btn-sm" href="{{route('Negocio/MisNegocios/Editar/', $negocios->id)}}">
                        					Editar
                        				</a>
	                        			<a class="btn m-btn--pill    btn-outline-danger btn-sm" href="{{route ('Negocio/MisNegocios/Borrar/', $negocios->id)}}">
	                        				Borrar
	                        			</a>
                        			</td>
    							</tr>
