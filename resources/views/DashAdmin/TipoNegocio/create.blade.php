		...
		<div class="col-sm-12 col-md-8 col-lg-9">
			...
			<div class="m-portlet m-portlet--tab">
				<div class="row">
					...
					<div class="col-xl-12">
						<!--begin::Form-->
						<form class="m-form m-form--fit m-form--label-align-right" role="form" method="POST" action="{{ route('Admin/TipoNegocio/Registro') }}">
							...
							<div class="m-portlet__body">
								...
								<div class="form-group m-form__group {{$errors->has('Nombre') ? 'has-error' : ''}}">
									...
									<div class="input-group m-input-group">
										...
										<input type="text" class="form-control m-input m-input--solid" id="Nombre" name="Nombre" placeholder="Nombre" value="{{ old('Nombre') }}" autofocus aria-describedby="user">
									</div>
								...
								<div class="form-group m-form__group {{$errors->has('Descripcion') ? 'has-error' : ''}}">
									...
									<div class="input-group m-input-group">
										...
										<textarea class="form-control m-input" id="Descripcion" name="Descripcion" rows="3">{{ old('Descripcion') }}</textarea>
									</div>
