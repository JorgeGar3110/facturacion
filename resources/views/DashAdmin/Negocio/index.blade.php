						...
						<div class="m-portlet__head">
							<div class="m-portlet__head-caption">
								<div class="m-portlet__head-title">
									...
									<br>
									<a href="{{route('Admin/Negocio/Registro')}}" class="btn btn-accent btn-sm m-btn m-btn--custom m-btn--icon m-btn--pill m-btn--air">Nuevo</a>
								</div>
							</div>
						</div>
					</div>
						...
						<tbody>
							@foreach($usersn as $usersns)
    							<tr>
                        			...
                        			@endif
                        			<td>
                        				<a class="btn m-btn--pill    btn-outline-info btn-sm" href="{{route ('Admin/Negocio/MisNegocios/', $usersns->id)}}">
                        					Ver negocios
                        				</a>
                        				@if($usersns->activo =='1')
	                        				<a class="btn m-btn--pill    btn-outline-danger btn-sm" href="{{route ('Admin/Negocio/Borrar/',$usersns->id)}}">
	                        					Borrar
	                        				</a>
	                        			@else 
                        					<a class="btn m-btn--pill    btn-outline-success btn-sm" href="{{route ('Admin/Negocio/Activar/',$usersns->id)}}">
                        						Activar
                        					</a>
                        				@endif
                        			</td>
