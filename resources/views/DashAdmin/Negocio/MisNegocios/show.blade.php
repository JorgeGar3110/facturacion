						...
						<div class="m-portlet__head">
							<div class="m-portlet__head-caption">
								<div class="m-portlet__head-title">
									...
									<br>
									<a href="{{route('Admin/Negocio/MisNegocios/Editar/', array($negocio->IdUsuario, $negocio->id))}}" class="btn btn-accent btn-sm m-btn m-btn--custom m-btn--icon m-btn--pill m-btn--air">Editar</a>
								</div>
							</div>
						</div>
					</div>
