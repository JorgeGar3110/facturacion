...
@section('content')
		...
		<div class="col-sm-12 col-md-8 col-lg-9">
			...
			<div class="m-portlet m-portlet--tab">
						...
						<div class="m-portlet__head">
							<div class="m-portlet__head-caption">
								<div class="m-portlet__head-title">
									...
									<br>
									<a href="{{route ('Admin/Negocio/MisNegocios/', $negocio->IdUsuario)}}" class="btn btn-accent btn-sm m-btn m-btn--custom m-btn--icon m-btn--pill m-btn--air">Listado</a>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-xl-12">
						<!--begin::Form-->
						<form class="m-form m-form--fit m-form--label-align-right" role="form" method="POST" action="{{ route('Admin/Negocio/MisNegocios/Editar/', array($negocio->IdUsuario, $negocio->id)) }}">
							...
							<div class="m-portlet__body">
								...
								<div class="form-group m-form__group {{$errors->has('Nombre') ? 'has-error' : ''}}">
									...
									<div class="input-group m-input-group">
										...
										<input type="text" class="form-control m-input m-input--solid" id="Nombre" name="Nombre" placeholder="Nombre" value="{{$negocio->Nombre}}" autofocus aria-describedby="user" value="">
									</div>
								...
								<div class="form-group m-form__group {{$errors->has('RazonSocial') ? 'has-error' : ''}}">
									...
									<div class="input-group m-input-group">
										...
										<input type="text" class="form-control m-input m-input--solid" id="RazonSocial" name="RazonSocial" aria-describedby="RazonSocialHelp" placeholder="Razon social" value="{{$negocio->RazonSocial}}" autofocus aria-describedby="arroba">
									</div>
								...
								<div class="form-group m-form__group {{$errors->has('RFC') ? 'has-error' : ''}}">
									...
									<div class="input-group m-input-group">
										...
										<input type="text" class="form-control m-input m-input--solid" id="RFC" name="RFC" aria-describedby="nameHelp" placeholder="RFC" value="{{$negocio->RFC}}" autofocus aria-describedby="arroba">
									</div>
									...
									<div class="row ">
										<div class="col-sm-12 col-md-8 col-lg-8">
											...
											<div class="input-group m-input-group">
												...
												<input type="text" class="form-control m-input m-input--solid" id="Calle" name="Calle" placeholder="Calle" value="{{$negocio->Calle}}" autofocus aria-describedby="user" value="">
											</div>
										...
										<div class="col-sm-12 col-md-4 col-lg-4">
											...
											<div class="input-group m-input-group">
												...
												<input type="text" class="form-control m-input m-input--solid" id="Numero" name="Numero" placeholder="Numero" value="{{$negocio->Numero}}" autofocus aria-describedby="user" value="">
											</div>
									...
									<div class="row ">
										<div class="col-sm-12 col-md-8 col-lg-8">
											...
											<div class="input-group m-input-group">
												...
												<input type="text" class="form-control m-input m-input--solid" id="Colonia" name="Colonia" placeholder="Colonia" value="{{$negocio->Colonia}}" autofocus aria-describedby="user" value="">
											</div>
										...
										<div class="col-sm-12 col-md-4 col-lg-4">
											...
											<div class="input-group m-input-group">
												...
												<input type="text" class="form-control m-input m-input--solid" id="CP" name="CP" placeholder="CP" value="{{$negocio->CP}}" autofocus aria-describedby="user" value="">
											</div>
								...
								<div class="form-group m-form__group {{$errors->has('Referencias') ? 'has-error' : ''}}">
									...
									<div class="input-group m-input-group">
										...
										<textarea class="form-control m-input" id="Referencias" name="Referencias" rows="3">{{$negocio->Referencias}}</textarea>
									</div>
								...
								<div class="form-group m-form__group {{$errors->has('Telefono') ? 'has-error' : ''}}">
									...
									<div class="input-group m-input-group">
										...
										<input type="text" class="form-control m-input m-input--solid" id="Telefono" name="Telefono" placeholder="Telefono" value="{{$negocio->Telefono}}" autofocus aria-describedby="user" value="">
									</div>
   ...
   <script>
   		$(document).ready(function() {
   			...
   			$("#IdEstatus").val("{{$negocio->IdEstatus}}");
   			$("#IdTipoNegocio").val("{{$negocio->IdTipoNegocio}}");
   			$("#Activo").val("{{$negocio->Activo}}");
   			$("#IdMunicipio").val("{{$negocio->IdMunicipio}}");
		});
