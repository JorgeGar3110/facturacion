...
@section('content')
	...
	<div class="row">
		<div class="col-xl-12">
			@include('DashAdmin.fragment.warning')
		...
		<div class="col-sm-12 col-md-8 col-lg-9">
			...
			<div class="m-portlet m-portlet--tab">
				<div class="row">
					...
					<div class="col-xl-12">
						<!--begin::Form-->
						<form class="m-form m-form--fit m-form--label-align-right" role="form" method="POST" action="{{ route('Admin/MisDatos') }}">
							...
							<div class="m-portlet__body">
								...
								<div class="form-group m-form__group {{$errors->has('Paterno') ? 'has-error' : ''}}">
									...
									<div class="input-group m-input-group">
										...
										<input type="text" class="form-control m-input m-input--solid" id="Paterno" name="Paterno" aria-describedby="PaternoHelp" placeholder="Apellido Paterno" value="{{$datos->Paterno}}" autofocus aria-describedby="arroba">
									</div>
								...
								<div class="form-group m-form__group {{$errors->has('Materno') ? 'has-error' : ''}}">
									...
									<div class="input-group m-input-group">
										...
										<input type="text" class="form-control m-input m-input--solid" id="Materno" name="Materno" aria-describedby="MaternoHelp" placeholder="Apellido Materno" value="{{$datos->Materno}}" autofocus aria-describedby="arroba">
									</div>
